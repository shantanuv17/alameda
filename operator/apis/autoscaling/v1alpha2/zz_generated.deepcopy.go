...
func (in *Controller) DeepCopyInto(out *Controller) {
	*out = *in
	in.ControllerTarget.DeepCopyInto(&out.ControllerTarget)
...
func (in *GenericHPAParameters) DeepCopyInto(out *GenericHPAParameters) {
	*out = *in
	in.HPAParameters.DeepCopyInto(&out.HPAParameters)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HPAParameters) DeepCopyInto(out *HPAParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HPAParameters.
func (in *HPAParameters) DeepCopy() *HPAParameters {
	if in == nil {
		return nil
	}
	out := new(HPAParameters)
	in.DeepCopyInto(out)
	return out
}
