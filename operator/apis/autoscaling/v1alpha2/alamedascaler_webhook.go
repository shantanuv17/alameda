...
// +kubebuilder:webhook:path=/mutate-autoscaling-containers-ai-v1alpha2-alamedascaler,mutating=true,failurePolicy=fail,groups=autoscaling.containers.ai,resources=alamedascalers,verbs=create;update,versions=v1alpha2,name=malamedascaler.containers.ai,sideEffects=None
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-autoscaling-containers-ai-v1alpha2-alamedascaler,mutating=false,failurePolicy=fail,groups=autoscaling.containers.ai,resources=alamedascalers,versions=v1alpha2,name=valamedascaler.containers.ai,sideEffects=None
