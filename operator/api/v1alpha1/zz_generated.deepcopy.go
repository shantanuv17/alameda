...
func (in *MetricRule) DeepCopyInto(out *MetricRule) {
	*out = *in
	...
	if in.DurationUpThresholdPercentage != nil {
		in, out := &in.DurationUpThresholdPercentage, &out.DurationUpThresholdPercentage
		*out = new(int32)
		**out = **in
	}
	if in.DurationDownThresholdPercentage != nil {
		in, out := &in.DurationDownThresholdPercentage, &out.DurationDownThresholdPercentage
		*out = new(int32)
		**out = **in
	}
}
...
func (in *NginxSpec) DeepCopyInto(out *NginxSpec) {
	*out = *in
	...
	if in.TargetResponseTime != nil {
		in, out := &in.TargetResponseTime, &out.TargetResponseTime
		*out = new(int64)
		**out = **in
	}
}
