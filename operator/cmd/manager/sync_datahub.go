...
func syncResourcesWithDatahub(client client.Client, datahubClient *datahubpkg.Client) {
	for {
	...
	go func() {
		if err := datahubKafkaRepo.SyncWithDatahub(context.Background(), client); err != nil {
