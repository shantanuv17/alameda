...
func DefaultSchemasInit() {
	...
	schemaList = append(schemaList, defaults.SchemaPredictionClusterAutoscalerMachinegroup())
	...
	// Resource
	schemaList = append(schemaList, defaults.SchemaResourceClusterAutoscalerMachinegroup())
