...
func DefaultSchemasInit() {
	...
	schemaList = append(schemaList, defaults.SchemaPredictionClusterAutoscalerMachineset())
	schemaList = append(schemaList, defaults.SchemaPredictionClusterAutoscalerNodeGroup())
	...
	// Resource
	schemaList = append(schemaList, defaults.SchemaResourceClusterAutoscalerClusterscaler())
	schemaList = append(schemaList, defaults.SchemaResourceClusterAutoscalerMachinescaler())
	schemaList = append(schemaList, defaults.SchemaResourceClusterAutoscalerMachineset())
