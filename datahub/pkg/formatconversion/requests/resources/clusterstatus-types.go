...
func NewAlamedaControllerSpec(controllerSpec *resources.AlamedaControllerSpec) *types.AlamedaControllerSpec {
	if controllerSpec != nil {
		...
		spec.MinReplicas = controllerSpec.GetMinReplicas()
		spec.MaxReplicas = controllerSpec.GetMaxReplicas()
...
func NewAlamedaApplicationSpec(applicationSpec *resources.AlamedaApplicationSpec) *types.AlamedaApplicationSpec {
	if applicationSpec != nil {
		...
		spec.AppSpec = applicationSpec.GetAppSpec()
		spec.Selector = applicationSpec.GetSelector()
		return spec
	}
	return nil
}
...
func NewAlamedaNodeSpec(nodeSpec *resources.AlamedaNodeSpec) *types.AlamedaNodeSpec {
	if nodeSpec != nil {
		...
		spec.MachinesetName = nodeSpec.GetMachinesetName()
		spec.MachinesetNamespace = nodeSpec.GetMachinesetNamespace()
		spec.RoleMaster = nodeSpec.GetRoleMaster()
		spec.RoleWorker = nodeSpec.GetRoleWorker()
		spec.RoleInfra = nodeSpec.GetRoleInfra()
		return spec
	}
	return nil
}
