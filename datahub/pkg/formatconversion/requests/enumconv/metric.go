...
var MetricTypeNameMap = map[ApiCommon.MetricType]schemas.MetricType{
	...
	ApiCommon.MetricType_CPU_MILLICORES_USAGE:       schemas.CPUMilliCoresUsage, // Change from CPUUsageSecondsPercentage
	ApiCommon.MetricType_CPU_MILLICORES_USAGE_PCT:   schemas.CPUMilliCoresUsagePCT,
	ApiCommon.MetricType_CPU_MILLICORES_ALLOCATABLE: schemas.CPUMilliCoresAllocatable,
	...
	ApiCommon.MetricType_MEMORY_BYTES_USAGE:         schemas.MemoryBytesUsage, // Change from MemoryUsageBytes
