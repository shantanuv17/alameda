...
type MetricNginxHttpResponseTotal struct {
	...
	Measurement                 *Measurement `name:"nginx_http_response_total" metric:"number" boundary:"undefined" quota:"undefined" ts:"true"`
	Time                        *time.Time   `json:"time"                           required:"false" column:"tag"`
	ClusterName                 string       `json:"cluster_name"                   required:"true"  column:"tag"`
...
type MetricNginxHttpResponseLatency struct {
	DatahubEntity               `scope:"metric" category:"nginx" type:"nginx"`
	Measurement                 *Measurement `name:"nginx_http_response_latency_ms" metric:"latency" boundary:"undefined" quota:"undefined" ts:"true"`
	Time                        *time.Time   `json:"time"                           required:"false" column:"tag"`
	ClusterName                 string       `json:"cluster_name"                   required:"true"  column:"tag"`
	ResourceK8sServiceName      string       `json:"resource_k8s_service_name"      required:"true"  column:"tag"`
	ResourceK8sServiceNamespace string       `json:"resource_k8s_service_namespace" required:"true"  column:"tag"`
