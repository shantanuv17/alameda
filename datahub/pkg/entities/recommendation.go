...
type RecommendationNginx struct {
	...
	Measurement      *Measurement `name:"nginx" metric:"undefined" boundary:"undefined" quota:"undefined" ts:"true"`
	Time             *time.Time   `json:"time"               required:"false" column:"tag"`
	Name             string       `json:"name"               required:"true"  column:"tag"`
	Namespace        string       `json:"namespace"          required:"true"  column:"tag"`
	ClusterName      string       `json:"cluster_name"       required:"true"  column:"tag"`
	...
	CurrentReplicas  int32        `json:"current_replicas"   required:"true"  column:"field"`
	DesiredReplicas  int32        `json:"desired_replicas"   required:"true"  column:"field"`
	ReplicaCapacity  float64      `json:"replica_capacity"   required:"true"  column:"field"`
	CurrentNumerator float64      `json:"current_numerator"  required:"true"  column:"field"`
	HttpResponseTime int64        `json:"http_response_time" required:"false" column:"field"`
	Alpha            float64      `json:"alpha"              required:"false" column:"field"`
	Mape0            float64      `json:"mape0"              required:"true"  column:"field"`
	Mape1            float64      `json:"mape1"              required:"true"  column:"field"`
	Mape2            float64      `json:"mape2"              required:"true"  column:"field"`
	Reserve          string       `json:"reserve"            required:"false" column:"field"`
}
...
type RecommendationClusterAutoscalerMachinegroup struct {
	...
	Measurement         *Measurement `name:"machinegroup" metric:"undefined" boundary:"undefined" quota:"undefined" ts:"true"`
	Time                *time.Time   `json:"time"                 required:"false" column:"tag"`
	Name                string       `json:"name"                 required:"true"  column:"tag"`
	Namespace           string       `json:"namespace"            required:"true"  column:"tag"`
	ClusterName         string       `json:"cluster_name"         required:"true"  column:"tag"`
	MachinesetName      string       `json:"machineset_name"      required:"true"  column:"field"`
	MachinesetNamespace string       `json:"machineset_namespace" required:"true"  column:"field"`
	CreateTime          int64        `json:"create_time"          required:"true"  column:"field"`
	CurrentReplicas     int32        `json:"current_replicas"     required:"true"  column:"field"`
	DesiredReplicas     int32        `json:"desired_replicas"     required:"true"  column:"field"`
}
