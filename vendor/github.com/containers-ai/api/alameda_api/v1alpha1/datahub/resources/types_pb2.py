...
_ALAMEDAAPPLICATIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='machinegroup_name', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaApplicationSpec.machinegroup_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='machinegroup_namespace', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaApplicationSpec.machinegroup_namespace', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
