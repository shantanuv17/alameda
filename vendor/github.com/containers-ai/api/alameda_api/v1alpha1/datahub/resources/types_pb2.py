...
_ALAMEDAAPPLICATIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_replicas', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaApplicationSpec.min_replicas', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_replicas', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaApplicationSpec.max_replicas', index=2,
