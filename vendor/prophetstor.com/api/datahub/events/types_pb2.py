...
_EVENTVERSION = _descriptor.EnumDescriptor(
  name='EventVersion',
  full_name='prophetstor.datahub.events.EventVersion',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_EVENTLEVEL = _descriptor.EnumDescriptor(
  name='EventLevel',
  full_name='prophetstor.datahub.events.EventLevel',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_EVENTSOURCE = _descriptor.Descriptor(
  name='EventSource',
  full_name='prophetstor.datahub.events.EventSource',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='host', full_name='prophetstor.datahub.events.EventSource.host', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='component', full_name='prophetstor.datahub.events.EventSource.component', index=1,
...
_K8SOBJECTREFERENCE = _descriptor.Descriptor(
  ...
  full_name='prophetstor.datahub.events.K8SObjectReference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='prophetstor.datahub.events.K8SObjectReference.kind', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='namespace', full_name='prophetstor.datahub.events.K8SObjectReference.namespace', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='prophetstor.datahub.events.K8SObjectReference.name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='api_version', full_name='prophetstor.datahub.events.K8SObjectReference.api_version', index=3,
...
EventSource = _reflection.GeneratedProtocolMessageType('EventSource', (_message.Message,), {
  ...
  '__module__' : 'datahub.events.types_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.events.EventSource)
  })
...
K8SObjectReference = _reflection.GeneratedProtocolMessageType('K8SObjectReference', (_message.Message,), {
  ...
  '__module__' : 'datahub.events.types_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.events.K8SObjectReference)
  })
