...
_METRICTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CPU_CORES_ALLOCATABLE', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CPU_MILLICORES_TOTAL', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CPU_MILLICORES_AVAIL', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CPU_MILLICORES_USAGE', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CPU_MILLICORES_USAGE_PCT', index=6, number=6,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MEMORY_BYTES_ALLOCATABLE', index=7, number=7,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MEMORY_BYTES_TOTAL', index=8, number=8,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MEMORY_BYTES_AVAIL', index=9, number=9,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MEMORY_BYTES_USAGE', index=10, number=10,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MEMORY_BYTES_USAGE_PCT', index=11, number=11,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_RESOURCENAME = _descriptor.EnumDescriptor(
  name='ResourceName',
  full_name='prophetstor.api.datahub.common.ResourceName',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_SAMPLE = _descriptor.Descriptor(
  name='Sample',
  full_name='prophetstor.api.datahub.common.Sample',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='prophetstor.api.datahub.common.Sample.time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='end_time', full_name='prophetstor.api.datahub.common.Sample.end_time', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='num_value', full_name='prophetstor.api.datahub.common.Sample.num_value', index=2,
...
_METRICDATA = _descriptor.Descriptor(
  name='MetricData',
  full_name='prophetstor.api.datahub.common.MetricData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='metric_type', full_name='prophetstor.api.datahub.common.MetricData.metric_type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='prophetstor.api.datahub.common.MetricData.data', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='granularity', full_name='prophetstor.api.datahub.common.MetricData.granularity', index=2,
...
Sample = _reflection.GeneratedProtocolMessageType('Sample', (_message.Message,), {
  'DESCRIPTOR' : _SAMPLE,
  '__module__' : 'prophetstor.api.datahub.common.metrics_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.api.datahub.common.Sample)
  })
...
MetricData = _reflection.GeneratedProtocolMessageType('MetricData', (_message.Message,), {
  ...
  '__module__' : 'prophetstor.api.datahub.common.metrics_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.api.datahub.common.MetricData)
  })
