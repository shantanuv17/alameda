...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='prophetstor/api/datahub/weavescope/services.proto',
  package='prophetstor.api.datahub.weavescope',
  syntax='proto3',
  serialized_options=b'Z&prophetstor.com/api/datahub/weavescope',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n1prophetstor/api/datahub/weavescope/services.proto\x12\"prophetstor.api.datahub.weavescope\x1a\x17google/rpc/status.proto\"-\n\x1aListWeaveScopeHostsRequest\x12\x0f\n\x07host_id\x18\x01 \x01(\t\"+\n\x19ListWeaveScopePodsRequest\x12\x0e\n\x06pod_id\x18\x01 \x01(\t\"7\n\x1fListWeaveScopeContainersRequest\x12\x14\n\x0c\x63ontainer_id\x18\x01 \x01(\t\"I\n\x12WeaveScopeResponse\x12\"\n\x06status\x18\x01 \x01(\x0b\x32\x12.google.rpc.Status\x12\x0f\n\x07rawdata\x18\x02 \x01(\tB(Z&prophetstor.com/api/datahub/weavescopeb\x06proto3'
  ,
...
_LISTWEAVESCOPEHOSTSREQUEST = _descriptor.Descriptor(
  ...
  full_name='prophetstor.api.datahub.weavescope.ListWeaveScopeHostsRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='host_id', full_name='prophetstor.api.datahub.weavescope.ListWeaveScopeHostsRequest.host_id', index=0,
...
_LISTWEAVESCOPEPODSREQUEST = _descriptor.Descriptor(
  ...
  full_name='prophetstor.api.datahub.weavescope.ListWeaveScopePodsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='pod_id', full_name='prophetstor.api.datahub.weavescope.ListWeaveScopePodsRequest.pod_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTWEAVESCOPECONTAINERSREQUEST = _descriptor.Descriptor(
  ...
  full_name='prophetstor.api.datahub.weavescope.ListWeaveScopeContainersRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='container_id', full_name='prophetstor.api.datahub.weavescope.ListWeaveScopeContainersRequest.container_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEAVESCOPERESPONSE = _descriptor.Descriptor(
  ...
  full_name='prophetstor.api.datahub.weavescope.WeaveScopeResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='prophetstor.api.datahub.weavescope.WeaveScopeResponse.status', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rawdata', full_name='prophetstor.api.datahub.weavescope.WeaveScopeResponse.rawdata', index=1,
...
ListWeaveScopeHostsRequest = _reflection.GeneratedProtocolMessageType('ListWeaveScopeHostsRequest', (_message.Message,), {
  ...
  '__module__' : 'prophetstor.api.datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.api.datahub.weavescope.ListWeaveScopeHostsRequest)
  })
...
ListWeaveScopePodsRequest = _reflection.GeneratedProtocolMessageType('ListWeaveScopePodsRequest', (_message.Message,), {
  ...
  '__module__' : 'prophetstor.api.datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.api.datahub.weavescope.ListWeaveScopePodsRequest)
  })
...
ListWeaveScopeContainersRequest = _reflection.GeneratedProtocolMessageType('ListWeaveScopeContainersRequest', (_message.Message,), {
  ...
  '__module__' : 'prophetstor.api.datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.api.datahub.weavescope.ListWeaveScopeContainersRequest)
  })
...
WeaveScopeResponse = _reflection.GeneratedProtocolMessageType('WeaveScopeResponse', (_message.Message,), {
  ...
  '__module__' : 'prophetstor.api.datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.api.datahub.weavescope.WeaveScopeResponse)
  })
