...
_LISTWEAVESCOPEHOSTSREQUEST = _descriptor.Descriptor(
  ...
  full_name='prophetstor.datahub.weavescope.ListWeaveScopeHostsRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='host_id', full_name='prophetstor.datahub.weavescope.ListWeaveScopeHostsRequest.host_id', index=0,
...
_LISTWEAVESCOPEPODSREQUEST = _descriptor.Descriptor(
  ...
  full_name='prophetstor.datahub.weavescope.ListWeaveScopePodsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='pod_id', full_name='prophetstor.datahub.weavescope.ListWeaveScopePodsRequest.pod_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTWEAVESCOPECONTAINERSREQUEST = _descriptor.Descriptor(
  ...
  full_name='prophetstor.datahub.weavescope.ListWeaveScopeContainersRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='container_id', full_name='prophetstor.datahub.weavescope.ListWeaveScopeContainersRequest.container_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEAVESCOPERESPONSE = _descriptor.Descriptor(
  ...
  full_name='prophetstor.datahub.weavescope.WeaveScopeResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='prophetstor.datahub.weavescope.WeaveScopeResponse.status', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rawdata', full_name='prophetstor.datahub.weavescope.WeaveScopeResponse.rawdata', index=1,
...
ListWeaveScopeHostsRequest = _reflection.GeneratedProtocolMessageType('ListWeaveScopeHostsRequest', (_message.Message,), {
  ...
  '__module__' : 'datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.weavescope.ListWeaveScopeHostsRequest)
  })
...
ListWeaveScopePodsRequest = _reflection.GeneratedProtocolMessageType('ListWeaveScopePodsRequest', (_message.Message,), {
  ...
  '__module__' : 'datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.weavescope.ListWeaveScopePodsRequest)
  })
...
ListWeaveScopeContainersRequest = _reflection.GeneratedProtocolMessageType('ListWeaveScopeContainersRequest', (_message.Message,), {
  ...
  '__module__' : 'datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.weavescope.ListWeaveScopeContainersRequest)
  })
...
WeaveScopeResponse = _reflection.GeneratedProtocolMessageType('WeaveScopeResponse', (_message.Message,), {
  ...
  '__module__' : 'datahub.weavescope.services_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.weavescope.WeaveScopeResponse)
  })
