...
_SCALINGTOOL = _descriptor.EnumDescriptor(
  name='ScalingTool',
  full_name='prophetstor.datahub.resources.ScalingTool',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_OBJECTMETA = _descriptor.Descriptor(
  name='ObjectMeta',
  full_name='prophetstor.datahub.resources.ObjectMeta',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='prophetstor.datahub.resources.ObjectMeta.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='namespace', full_name='prophetstor.datahub.resources.ObjectMeta.namespace', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='node_name', full_name='prophetstor.datahub.resources.ObjectMeta.node_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cluster_name', full_name='prophetstor.datahub.resources.ObjectMeta.cluster_name', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='uid', full_name='prophetstor.datahub.resources.ObjectMeta.uid', index=4,
...
_OWNERREFERENCE = _descriptor.Descriptor(
  name='OwnerReference',
  full_name='prophetstor.datahub.resources.OwnerReference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='object_meta', full_name='prophetstor.datahub.resources.OwnerReference.object_meta', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='kind', full_name='prophetstor.datahub.resources.OwnerReference.kind', index=1,
...
ObjectMeta = _reflection.GeneratedProtocolMessageType('ObjectMeta', (_message.Message,), {
  ...
  '__module__' : 'datahub.resources.metadata_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.resources.ObjectMeta)
  })
...
OwnerReference = _reflection.GeneratedProtocolMessageType('OwnerReference', (_message.Message,), {
  ...
  '__module__' : 'datahub.resources.metadata_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.resources.OwnerReference)
  })
