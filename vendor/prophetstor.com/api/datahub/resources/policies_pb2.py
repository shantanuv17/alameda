...
_NODEPRIORITY = _descriptor.Descriptor(
  name='NodePriority',
  full_name='prophetstor.datahub.resources.NodePriority',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='nodes', full_name='prophetstor.datahub.resources.NodePriority.nodes', index=0,
...
_SELECTOR_SELECTORENTRY = _descriptor.Descriptor(
  name='SelectorEntry',
  full_name='prophetstor.datahub.resources.Selector.SelectorEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='prophetstor.datahub.resources.Selector.SelectorEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='prophetstor.datahub.resources.Selector.SelectorEntry.value', index=1,
...
_SELECTOR = _descriptor.Descriptor(
  name='Selector',
  full_name='prophetstor.datahub.resources.Selector',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='selector', full_name='prophetstor.datahub.resources.Selector.selector', index=0,
...
_ASSIGNPODPOLICY = _descriptor.Descriptor(
  ...
  full_name='prophetstor.datahub.resources.AssignPodPolicy',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='prophetstor.datahub.resources.AssignPodPolicy.time', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='node_priority', full_name='prophetstor.datahub.resources.AssignPodPolicy.node_priority', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='node_selector', full_name='prophetstor.datahub.resources.AssignPodPolicy.node_selector', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='node_name', full_name='prophetstor.datahub.resources.AssignPodPolicy.node_name', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='policy', full_name='prophetstor.datahub.resources.AssignPodPolicy.policy',
...
NodePriority = _reflection.GeneratedProtocolMessageType('NodePriority', (_message.Message,), {
  ...
  '__module__' : 'datahub.resources.policies_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.resources.NodePriority)
  })
...
Selector = _reflection.GeneratedProtocolMessageType('Selector', (_message.Message,), {
  ...
  'SelectorEntry' : _reflection.GeneratedProtocolMessageType('SelectorEntry', (_message.Message,), {
    ...
    '__module__' : 'datahub.resources.policies_pb2'
    # @@protoc_insertion_point(class_scope:prophetstor.datahub.resources.Selector.SelectorEntry)
    })
  ,
  'DESCRIPTOR' : _SELECTOR,
  '__module__' : 'datahub.resources.policies_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.resources.Selector)
  })
...
AssignPodPolicy = _reflection.GeneratedProtocolMessageType('AssignPodPolicy', (_message.Message,), {
  ...
  '__module__' : 'datahub.resources.policies_pb2'
  # @@protoc_insertion_point(class_scope:prophetstor.datahub.resources.AssignPodPolicy)
  })
